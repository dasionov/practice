...
import (
	...
	virtapi "practice/pkg/monitoring/metrics/virt-api"
	virtcontroller "practice/pkg/monitoring/metrics/virt-controller"
	virthandler "practice/pkg/monitoring/metrics/virt-handler"
	virtoperator "practice/pkg/monitoring/metrics/virt-operator"
	"practice/pkg/monitoring/rules"
